...
public class Tracker
{
    ...
    public void Init(long id)
    {
        ...
        AddTrackableEvent<StartEvent>(true);
        AddTrackableEvent<EndEvent>(true);
        AddTrackableEvent<DDAGraphActEvent>(true);
        AddTrackableEvent<GraphDifficEvent>(true);
        AddTrackableEvent<LevelDifficultyEvent>(true);
        AddTrackableEvent<EndLevelEvent>(true);
        AddTrackableEvent<StartLevelEvent>(true);
        AddTrackableEvent<LostHealthEvent>(true);
        AddTrackableEvent<BulletDodgedEvent>(true);
        AddTrackableEvent<EnemyDamageEvent>(true);
        AddTrackableEvent<ShotEvent>(true);
        AddTrackableEvent<DashEvent>(true);
        AddTrackableEvent<EndPauseEvent>(true);
        AddTrackableEvent<FormDataEvent>(true);
        AddTrackableEvent<StartPauseEvent>(true);
        AddTrackableEvent<EnemyDeath>(true);
