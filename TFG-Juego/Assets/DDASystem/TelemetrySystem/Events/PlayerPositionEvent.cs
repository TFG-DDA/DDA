...
public class PlayerPositionXML : DataXML
{
    public string x_pos;
}

public class PlayerPositionEvent : TrackerEvent
{
    // Atributos del evento
    Vector2 pos;

    public PlayerPositionEvent(Vector2 p) : base(typeof(PlayerPositionEvent).Name)
    {
        pos = p;
    }
